...
// configuration step. It creates a namespace called `Tracking`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Tracking::cmake::project_name, Tracking::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", Tracking::cmake::project_version);
      return EXIT_SUCCESS;
    }
